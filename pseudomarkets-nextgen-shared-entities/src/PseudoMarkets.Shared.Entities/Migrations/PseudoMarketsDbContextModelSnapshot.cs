...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PseudoMarkets.Shared.Entities.Entities.OrderExecution.OrderExecutionEntity", b =>
                {
                    ...
                    b.ToTable("order_executions", (string)null);
                });

            modelBuilder.Entity("PseudoMarkets.Shared.Entities.Entities.OrderExecution.QueuedOrderEntity", b =>
                {
                    b.Property<Guid>("OrderId")
                        .ValueGeneratedNever()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("queued_orders", (string)null);
                });
            ...
            modelBuilder.Entity("PseudoMarkets.Shared.Entities.Entities.TransactionProcessing.AccountBalanceEntity", b =>
                {
                    ...
                    b.Property<decimal>("SettledCashBalance")
                        .HasPrecision(18, 4)
                        .HasColumnType("numeric(18,4)")
                        .HasColumnName("settled_cash_balance");

                    b.Property<decimal>("UnsettledCashBalance")
                        .HasPrecision(18, 4)
                        .HasColumnType("numeric(18,4)")
                        .HasColumnName("unsettled_cash_balance");
            ...
            modelBuilder.Entity("PseudoMarkets.Shared.Entities.Entities.TransactionProcessing.PositionEntity", b =>
                {
                    ...
                    b.Property<decimal>("SettledCostBasisTotal")
                        .HasPrecision(18, 4)
                        .HasColumnType("numeric(18,4)")
                        .HasColumnName("settled_cost_basis_total");

                    b.Property<decimal>("SettledQuantity")
                        .HasPrecision(18, 6)
                        .HasColumnType("numeric(18,6)")
                        .HasColumnName("settled_quantity");
                    ...
                    b.Property<decimal>("UnsettledCostBasisTotal")
                        .HasPrecision(18, 4)
                        .HasColumnType("numeric(18,4)")
                        .HasColumnName("unsettled_cost_basis_total");

                    b.Property<decimal>("UnsettledQuantity")
                        .HasPrecision(18, 6)
                        .HasColumnType("numeric(18,6)")
                        .HasColumnName("unsettled_quantity");
            ...
            modelBuilder.Entity("PseudoMarkets.Shared.Entities.Entities.TransactionProcessing.PositionLotEntity", b =>
                {
                    ...
                    b.Property<decimal>("SettledQuantityRemaining")
                        .HasPrecision(18, 6)
                        .HasColumnType("numeric(18,6)")
                        .HasColumnName("settled_quantity_remaining");
                    ...
                    b.Property<decimal>("UnsettledQuantityRemaining")
                        .HasPrecision(18, 6)
                        .HasColumnType("numeric(18,6)")
                        .HasColumnName("unsettled_quantity_remaining");
            ...
            modelBuilder.Entity("PseudoMarkets.Shared.Entities.Entities.TransactionProcessing.TradeExecutionEntity", b =>
                {
                    ...
                    b.HasIndex("SettlementDate", "TradeSide");
