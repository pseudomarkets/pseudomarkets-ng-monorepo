...
using PseudoMarkets.BalancesAndPositions.Core.DependencyInjection;
using PseudoMarkets.BalancesAndPositions.Persistence.DependencyInjection;
using PseudoMarkets.BalancesAndPositions.Service.Infrastructure;
...
namespace PseudoMarkets.BalancesAndPositions.Service;
...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        builder.Services.AddExceptionHandler<BalancesAndPositionsExceptionHandler>();
        ...
        builder.Services.AddBalancesAndPositionsCore(builder.Configuration);
        builder.Services.AddBalancesAndPositionsPersistence(builder.Configuration);
